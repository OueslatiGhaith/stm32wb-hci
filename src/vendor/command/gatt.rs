...
use crate::{BadStatusError, ConnectionHandle, Status, vendor::event::AttributeHandle};
...
pub trait GattCommands {
    ...
    /// generated.
    async fn add_service(&self, params: &AddServiceParameters) -> Result<(), Error>;
    ...
    /// A [Command complete](crate::event::command::CommandComplete) event is
    /// generated.
    async fn include_service(&self, params: &IncludeServiceParameters) -> Result<(), Error>;
    ...
    async fn add_characteristic(&self, params: &AddCharacteristicParameters) -> Result<(), Error>;
        ...
        + for<'t> ControllerCmdSync<GattAddCharacteristic<'t>>,
{
    ...
    hci_impl_variable_length_params!(add_service, AddServiceParameters, GattAddService);
    ...
    async fn read_handle_value_offset(
        ...
        GattReadHandleValueOffset::new(&bytes)
            .exec(self)
            .await
            .map_err(|e| e.into())
    }
