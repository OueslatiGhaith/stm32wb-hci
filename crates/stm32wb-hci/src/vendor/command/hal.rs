...
pub trait HalCommands {
    ...
    // compliance: st=ACI_HAL_GET_FW_BUILD_NUMBER
    ...
    // compliance: st=ACI_HAL_WRITE_CONFIG_DATA
    ...
    ///
    /// The controller will generate a [command complete](crate::event::command::CommandComplete) event.
    // compliance: st=ACI_HAL_READ_CONFIG_DATA
    ...
    ///
    /// The controller will generate a [command complete](crate::event::command::CommandComplete) event.
    // compliance: st=ACI_HAL_SET_TX_POWER_LEVEL
    ...
    ///
    /// The controller will generate a [command complete](crate::event::command::CommandComplete) event.
    // compliance: st=ACI_HAL_LE_TX_TEST_PACKET_NUMBER
    ...
    ///
    /// The controller will generate a [command complete](crate::event::command::CommandComplete) event.
    // compliance: st=ACI_HAL_TONE_START
    ...
    ///
    /// The controller will generate a [command complete](crate::event::command::CommandComplete) event.
    // compliance: st=ACI_HAL_TONE_STOP
    ...
    ///
    /// The controller will generate a [command complete](crate::event::command::CommandComplete) event.
    // compliance: st=ACI_HAL_GET_LINK_STATUS
    ...
    /// [End of Radio Activity](crate::vendor::event::VendorEvent::EndOfRadioActivity) event.
    // compliance: st=ACI_HAL_SET_RADIO_ACTIVITY_MASK
    ...
    ///
    /// The controller will generate a [command complete](crate::event::command::CommandComplete) event.
    // compliance: st=ACI_HAL_GET_ANCHOR_PERIOD
    ...
    // compliance: st=ACI_HAL_SET_EVENT_MASK
    ...
    // compliance: st=ACI_HAL_GET_PM_DEBUG_INFO
    ...
    // compliance: st=ACI_HAL_SET_SLAVE_LATENCY
    ...
    // compliance: st=ACI_HAL_STACK_RESET
