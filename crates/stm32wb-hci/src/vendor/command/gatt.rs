...
pub trait GattCommands {
    ...
    // compliance: st=ACI_GATT_INIT opcode=GATT_INIT
    ...
    /// generated.
    // compliance: st=ACI_GATT_ADD_SERVICE opcode=GATT_ADD_SERVICE
    ...
    /// A [Command complete](crate::event::command::CommandComplete) event is
    /// generated.
    // compliance: st=ACI_GATT_INCLUDE_SERVICE opcode=GATT_INCLUDE_SERVICE
    ...
    // compliance: st=ACI_GATT_ADD_CHAR opcode=GATT_ADD_CHARACTERISTIC
    ...
    // compliance: st=ACI_GATT_ADD_CHAR_DESC opcode=GATT_ADD_CHARACTERISTIC_DESCRIPTOR
    ...
    // compliance: st=ACI_GATT_UPDATE_CHAR_VALUE opcode=GATT_UPDATE_CHARACTERISTIC_VALUE
    ...
    /// When the command has completed, the controller will generate a
    /// [command complete](crate::event::command::CommandComplete) event.
    // compliance: st=ACI_GATT_DEL_CHAR opcode=GATT_DELETE_CHARACTERISTIC
    ...
    /// When the command has completed, the controller will generate a
    /// [command complete](crate::event::command::CommandComplete) event.
    // compliance: st=ACI_GATT_DEL_SERVICE opcode=GATT_DELETE_SERVICE
    ...
    /// When the command has completed, the controller will generate a
    /// [command complete](crate::event::command::CommandComplete) event.
    // compliance: st=ACI_GATT_DEL_INCLUDE_SERVICE opcode=GATT_DELETE_INCLUDED_SERVICE
    ...
    // compliance: st=ACI_GATT_SET_EVENT_MASK opcode=GATT_SET_EVENT_MASK
    ...
    // compliance: st=ACI_GATT_EXCHANGE_CONFIG opcode=GATT_EXCHANGE_CONFIGURATION
    ...
    // compliance: st=ACI_ATT_FIND_INFO_REQ opcode=GATT_FIND_INFORMATION_REQUEST
    ...
    /// procedure is indicated by a [Gatt Procedure Complete](crate::vendor::event::VendorEvent::GattProcedureComplete) event.
    // compliance: st=ACI_ATT_FIND_BY_TYPE_VALUE_REQ opcode=GATT_FIND_BY_TYPE_VALUE_REQUEST
    ...
    // compliance: st=ACI_ATT_READ_BY_TYPE_REQ opcode=GATT_READ_BY_TYPE_REQUEST
    ...
    /// procedure is indicated by a [GATT Procedure Complete](crate::vendor::event::VendorEvent::GattProcedureComplete) event.
    // compliance: st=ACI_ATT_READ_BY_GROUP_TYPE_REQ opcode=GATT_READ_BY_GROUP_TYPE_REQUEST
    ...
    /// procedure is indicated by a [GATT Procedure Complete](crate::vendor::event::VendorEvent::GattProcedureComplete) event.
    // compliance: st=ACI_ATT_PREPARE_WRITE_REQ opcode=GATT_PREPARE_WRITE_REQUEST
    ...
    /// procedure is indicated by a [GATT Procedure Complete](crate::vendor::event::VendorEvent::GattProcedureComplete) event.
    // compliance: st=ACI_ATT_EXECUTE_WRITE_REQ opcode=GATT_EXECUTE_WRITE_REQUEST
    ...
    /// procedure is indicated by a [GATT Procedure Complete](crate::vendor::event::VendorEvent::GattProcedureComplete) event.
    // compliance: st=ACI_GATT_DISC_ALL_PRIMARY_SERVICES opcode=GATT_DISCOVER_ALL_PRIMARY_SERVICES
    ...
    /// [Find By Type Value Response](crate::vendor::event::VendorEvent::AttFindByTypeValueResponse) event. The end of the
    /// procedure is indicated by a [Gatt Procedure Complete](crate::vendor::event::VendorEvent::GattProcedureComplete) event.
    // compliance: st=ACI_GATT_DISC_PRIMARY_SERVICE_BY_UUID opcode=GATT_DISCOVER_PRIMARY_SERVICES_BY_UUID
    ...
    /// [Read By Type Response](crate::vendor::event::VendorEvent::AttReadByTypeResponse) event. The end of the procedure
    /// is indicated by a [GATT Procedure Complete](crate::vendor::event::VendorEvent::GattProcedureComplete) event.
    // compliance: st=ACI_GATT_FIND_INCLUDED_SERVICES opcode=GATT_FIND_INCLUDED_SERVICES
    ...
    /// [Read By Type Response](crate::vendor::event::VendorEvent::AttReadByTypeResponse) event. The end of the procedure
    /// is indicated by a [GATT Procedure Complete](crate::vendor::event::VendorEvent::GattProcedureComplete) event.
    // compliance: st=ACI_GATT_DISC_ALL_CHAR_OF_SERVICE opcode=GATT_DISCOVER_ALL_CHARACTERISTICS_OF_SERVICE
    ...
    // compliance: st=ACI_GATT_DISC_CHAR_BY_UUID opcode=GATT_DISCOVER_CHARACTERISTICS_BY_UUID
    ...
    /// [Find Information Response](crate::vendor::event::VendorEvent::AttFindInformationResponse) event. The end of the
    /// procedure is indicated by a [GATT Procedure Complete](crate::vendor::event::VendorEvent::GattProcedureComplete) event.
    // compliance: st=ACI_GATT_DISC_ALL_CHAR_DESC opcode=GATT_DISCOVER_ALL_CHARACTERISTIC_DESCRIPTORS
    ...
    /// event.
    // compliance: st=ACI_GATT_READ_CHAR_VALUE opcode=GATT_READ_CHARACTERISTIC_VALUE
    ...
    /// event. The end of the procedure is indicated by a
    /// [GATT Procedure Complete](crate::vendor::event::VendorEvent::GattProcedureComplete) event.
    // compliance: st=ACI_GATT_READ_USING_CHAR_UUID opcode=GATT_READ_CHARACTERISTIC_BY_UUID
    ...
    /// is indicated by a [GATT Procedure Complete](crate::vendor::event::VendorEvent::GattProcedureComplete) event.
    // compliance: st=ACI_GATT_READ_LONG_CHAR_VALUE opcode=GATT_READ_LONG_CHARACTERISTIC_VALUE
    ...
    /// procedure is indicated by a [GATT Procedure Complete](crate::vendor::event::VendorEvent::GattProcedureComplete) event.
    // compliance: st=ACI_GATT_READ_MULTIPLE_CHAR_VALUE opcode=GATT_READ_MULTIPLE_CHARACTERISTIC_VALUES
    ...
    // compliance: st=ACI_GATT_WRITE_CHAR_VALUE opcode=GATT_WRITE_CHARACTERISTIC_VALUE
    ...
    /// event is generated.
    // compliance: st=ACI_GATT_WRITE_LONG_CHAR_VALUE opcode=GATT_WRITE_LONG_CHARACTERISTIC_VALUE
    ...
    /// completed, a [GATT Procedure Complete](crate::vendor::event::VendorEvent::GattProcedureComplete)
    /// event is generated.
    // compliance: st=ACI_GATT_WRITE_CHAR_RELIABLE opcode=GATT_WRITE_CHARACTERISTIC_VALUE_RELIABLY
    ...
    /// completed, a [GATT Procedure Complete](crate::vendor::event::VendorEvent::GattProcedureComplete)
    /// event is generated.
    // compliance: st=ACI_GATT_WRITE_LONG_CHAR_DESC opcode=GATT_WRITE_LONG_CHARACTERISTIC_DESCRIPTOR
    ...
    /// [Read Blob Response](crate::vendor::event::VendorEvent::AttReadBlobResponse) event. The end of the procedure
    /// is indicated by a [GATT Procedure Complete](crate::vendor::event::VendorEvent::GattProcedureComplete) event.
    // compliance: st=ACI_GATT_READ_LONG_CHAR_DESC opcode=GATT_READ_LONG_CHARACTERISTIC_DESCRIPTOR
    ...
    /// the command. When the procedure is completed, a
    /// [GATT Procedure Complete](crate::vendor::event::VendorEvent::GattProcedureComplete) event is generated.
    // compliance: st=ACI_GATT_WRITE_CHAR_DESC opcode=GATT_WRITE_CHARACTERISTIC_DESCRIPTOR
    ...
    /// indicated by a [GATT Procedure Complete](crate::vendor::event::VendorEvent::GattProcedureComplete)
    /// event.
    // compliance: st=ACI_GATT_READ_CHAR_DESC opcode=GATT_READ_CHARACTERISTIC_DESCRIPTOR
    ...
    // compliance: st=ACI_GATT_WRITE_WITHOUT_RESP opcode=GATT_WRITE_WITHOUT_RESPONSE
    ...
    // compliance: st=ACI_GATT_SIGNED_WRITE_WITHOUT_RESP opcode=GATT_SIGNED_WRITE_WITHOUT_RESPONSE
    ...
    // compliance: st=ACI_GATT_CONFIRM_INDICATION opcode=GATT_CONFIRM_INDICATION
    ...
    /// A [command complete](crate::event::command::CommandComplete) event is
    /// generated when this command is processed.
    // compliance: st=ACI_GATT_WRITE_RESP opcode=GATT_WRITE_RESPONSE
    ...
    /// A [command complete](crate::event::command::CommandComplete) event is
    /// generated when this command is processed.
    // compliance: st=ACI_GATT_ALLOW_READ opcode=GATT_ALLOW_READ
    ...
    /// A [command complete](crate::event::command::CommandComplete)
    /// event is generated when this command is processed.
    // compliance: st=ACI_GATT_SET_SECURITY_PERMISSION opcode=GATT_SET_SECURITY_PERMISSION
    ...
    /// A [command complete](crate::event::command::CommandComplete) event
    /// is generated when this command is processed.
    // compliance: st=ACI_GATT_SET_DESC_VALUE opcode=GATT_SET_DESCRIPTOR_VALUE
    ...
    /// When the command has completed, the controller will generate a
    /// [command complete](crate::event::command::CommandComplete) event.
    // compliance: st=ACI_GATT_UPDATE_CHAR_VALUE_EXT opcode=GATT_UPDATE_LONG_CHARACTERISTIC_VALUE
    ...
    // compliance: st=ACI_GATT_DENY_READ opcode=GATT_DENY_READ
    ...
    // compliance: st=ACI_GATT_SET_ACCESS_PERMISSION opcode=GATT_SET_ACCESS_PERMISSION
    ...
    // compliance: st=ACI_GATT_STORE_DB opcode=GATT_STORE_DB
    ...
    /// declarations.
    // compliance: st=ACI_GATT_SEND_MULT_NOTIFICATION opcode=GATT_SEND_MULT_NOTIFICATION
    ...
    /// event.
    // compliance: st=ACI_GATT_READ_MULTIPLE_VAR_CHAR_VALUE opcode=GATT_READ_MULTIPLE_VAR_CHAR_VALUE
