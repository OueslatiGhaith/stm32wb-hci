...
pub trait GattCommands {
    ...
    /// generated.
    // compliance: st=ACI_GATT_ADD_SERVICE
    ...
    /// A [Command complete](crate::event::command::CommandComplete) event is
    /// generated.
    // compliance: st=ACI_GATT_INCLUDE_SERVICE
    ...
    // compliance: st=ACI_GATT_ADD_CHAR
    ...
    // compliance: st=ACI_GATT_ADD_CHAR_DESC
    ...
    // compliance: st=ACI_GATT_UPDATE_CHAR_VALUE
    ...
    /// When the command has completed, the controller will generate a
    /// [command complete](crate::event::command::CommandComplete) event.
    // compliance: st=ACI_GATT_DEL_CHAR
    ...
    /// When the command has completed, the controller will generate a
    /// [command complete](crate::event::command::CommandComplete) event.
    // compliance: st=ACI_GATT_DEL_SERVICE
    ...
    /// When the command has completed, the controller will generate a
    /// [command complete](crate::event::command::CommandComplete) event.
    // compliance: st=ACI_GATT_DEL_INCLUDE_SERVICE
    ...
    // compliance: st=ACI_GATT_SET_EVENT_MASK
    ...
    // compliance: st=ACI_GATT_EXCHANGE_CONFIG
    ...
    // compliance: st=ACI_ATT_FIND_INFO_REQ
    ...
    /// procedure is indicated by a [Gatt Procedure Complete](crate::vendor::event::VendorEvent::GattProcedureComplete) event.
    // compliance: st=ACI_ATT_FIND_BY_TYPE_VALUE_REQ
    ...
    // compliance: st=ACI_ATT_READ_BY_TYPE_REQ
    ...
    /// procedure is indicated by a [GATT Procedure Complete](crate::vendor::event::VendorEvent::GattProcedureComplete) event.
    // compliance: st=ACI_ATT_READ_BY_GROUP_TYPE_REQ
    ...
    /// procedure is indicated by a [GATT Procedure Complete](crate::vendor::event::VendorEvent::GattProcedureComplete) event.
    // compliance: st=ACI_ATT_PREPARE_WRITE_REQ
    ...
    /// procedure is indicated by a [GATT Procedure Complete](crate::vendor::event::VendorEvent::GattProcedureComplete) event.
    // compliance: st=ACI_ATT_EXECUTE_WRITE_REQ
    ...
    /// procedure is indicated by a [GATT Procedure Complete](crate::vendor::event::VendorEvent::GattProcedureComplete) event.
    // compliance: st=ACI_GATT_DISC_ALL_PRIMARY_SERVICES
    ...
    /// [Find By Type Value Response](crate::vendor::event::VendorEvent::AttFindByTypeValueResponse) event. The end of the
    /// procedure is indicated by a [Gatt Procedure Complete](crate::vendor::event::VendorEvent::GattProcedureComplete) event.
    // compliance: st=ACI_GATT_DISC_PRIMARY_SERVICE_BY_UUID
    ...
    /// [Read By Type Response](crate::vendor::event::VendorEvent::AttReadByTypeResponse) event. The end of the procedure
    /// is indicated by a [GATT Procedure Complete](crate::vendor::event::VendorEvent::GattProcedureComplete) event.
    // compliance: st=ACI_GATT_FIND_INCLUDED_SERVICES
    ...
    /// [Read By Type Response](crate::vendor::event::VendorEvent::AttReadByTypeResponse) event. The end of the procedure
    /// is indicated by a [GATT Procedure Complete](crate::vendor::event::VendorEvent::GattProcedureComplete) event.
    // compliance: st=ACI_GATT_DISC_ALL_CHAR_OF_SERVICE
    ...
    // compliance: st=ACI_GATT_DISC_CHAR_BY_UUID
    ...
    /// [Find Information Response](crate::vendor::event::VendorEvent::AttFindInformationResponse) event. The end of the
    /// procedure is indicated by a [GATT Procedure Complete](crate::vendor::event::VendorEvent::GattProcedureComplete) event.
    // compliance: st=ACI_GATT_DISC_ALL_CHAR_DESC
    ...
    /// event.
    // compliance: st=ACI_GATT_READ_CHAR_VALUE
    ...
    /// event. The end of the procedure is indicated by a
    /// [GATT Procedure Complete](crate::vendor::event::VendorEvent::GattProcedureComplete) event.
    // compliance: st=ACI_GATT_READ_USING_CHAR_UUID
    ...
    /// is indicated by a [GATT Procedure Complete](crate::vendor::event::VendorEvent::GattProcedureComplete) event.
    // compliance: st=ACI_GATT_READ_LONG_CHAR_VALUE
    ...
    /// procedure is indicated by a [GATT Procedure Complete](crate::vendor::event::VendorEvent::GattProcedureComplete) event.
    // compliance: st=ACI_GATT_READ_MULTIPLE_CHAR_VALUE
    ...
    // compliance: st=ACI_GATT_WRITE_CHAR_VALUE
    ...
    /// event is generated.
    // compliance: st=ACI_GATT_WRITE_LONG_CHAR_VALUE
    ...
    /// completed, a [GATT Procedure Complete](crate::vendor::event::VendorEvent::GattProcedureComplete)
    /// event is generated.
    // compliance: st=ACI_GATT_WRITE_CHAR_RELIABLE
    ...
    /// completed, a [GATT Procedure Complete](crate::vendor::event::VendorEvent::GattProcedureComplete)
    /// event is generated.
    // compliance: st=ACI_GATT_WRITE_LONG_CHAR_DESC
    ...
    /// [Read Blob Response](crate::vendor::event::VendorEvent::AttReadBlobResponse) event. The end of the procedure
    /// is indicated by a [GATT Procedure Complete](crate::vendor::event::VendorEvent::GattProcedureComplete) event.
    // compliance: st=ACI_GATT_READ_LONG_CHAR_DESC
    ...
    /// the command. When the procedure is completed, a
    /// [GATT Procedure Complete](crate::vendor::event::VendorEvent::GattProcedureComplete) event is generated.
    // compliance: st=ACI_GATT_WRITE_CHAR_DESC
    ...
    /// indicated by a [GATT Procedure Complete](crate::vendor::event::VendorEvent::GattProcedureComplete)
    /// event.
    // compliance: st=ACI_GATT_READ_CHAR_DESC
    ...
    // compliance: st=ACI_GATT_WRITE_WITHOUT_RESP
    ...
    // compliance: st=ACI_GATT_SIGNED_WRITE_WITHOUT_RESP
    ...
    // compliance: st=ACI_GATT_CONFIRM_INDICATION
    ...
    /// A [command complete](crate::event::command::CommandComplete) event is
    /// generated when this command is processed.
    // compliance: st=ACI_GATT_WRITE_RESP
    ...
    /// A [command complete](crate::event::command::CommandComplete) event is
    /// generated when this command is processed.
    // compliance: st=ACI_GATT_ALLOW_READ
    ...
    /// A [command complete](crate::event::command::CommandComplete)
    /// event is generated when this command is processed.
    // compliance: st=ACI_GATT_SET_SECURITY_PERMISSION
    ...
    /// A [command complete](crate::event::command::CommandComplete) event
    /// is generated when this command is processed.
    // compliance: st=ACI_GATT_SET_DESC_VALUE
    ...
    /// A [command complete](crate::event::command::CommandComplete)
    /// event is generated when this command is processed.
    // compliance: st=ACI_GATT_READ_HANDLE_VALUE
    ...
    /// When the command has completed, the controller will generate a
    /// [command complete](crate::event::command::CommandComplete) event.
    // compliance: st=ACI_GATT_UPDATE_CHAR_VALUE_EXT
    ...
    // compliance: st=ACI_GATT_DENY_READ
    ...
    // compliance: st=ACI_GATT_SET_ACCESS_PERMISSION
    ...
    // compliance: st=ACI_GATT_STORE_DB
