...
pub enum VendorEvent {
    ...
    /// timeout (180 seconds).
    // compliance: event=ACI_GAP_LIMITED_DISCOVERABLE_EVENT
    ...
    // compliance: event=ACI_GAP_PAIRING_COMPLETE_EVENT
    ...
    // compliance: event=ACI_GAP_PASS_KEY_REQ_EVENT
    ...
    // compliance: event=ACI_GAP_AUTHORIZATION_REQ_EVENT
    ...
    /// central device.
    // compliance: event=ACI_GAP_SLAVE_SECURITY_INITIATED_EVENT
    ...
    // compliance: event=ACI_GAP_BOND_LOST_EVENT
    GapBondLost,
    ...
    // compliance: event=ACI_GAP_PROC_COMPLETE_EVENT
    ...
    // compliance: event=ACI_GAP_ADDR_NOT_RESOLVED_EVENT
    ...
    /// command.
    // compliance: event=ACI_GAP_NUMERIC_COMPARISON_VALUE_EVENT
    ...
    // compliance: event=ACI_GAP_KEYPRESS_NOTIFICATION_EVENT
    ...
    // compliance: event=ACI_L2CAP_CONNECTION_UPDATE_RESP_EVENT
    ...
    // compliance: event=ACI_L2CAP_PROC_TIMEOUT_EVENT
    ...
    // compliance: event=ACI_L2CAP_CONNECTION_UPDATE_REQ_EVENT
    ...
    // compliance: event=ACI_L2CAP_COMMAND_REJECT_EVENT
    ...
    // compliance: event=ACI_L2CAP_COC_RX_DATA_EVENT
    ...
    // compliance: event=ACI_L2CAP_COC_TX_POOL_AVAILABLE_EVENT
    ...
    /// - reliable write
    // compliance: event=ACI_GATT_ATTRIBUTE_MODIFIED_EVENT
    ...
    // compliance: event=ACI_ATT_READ_BLOB_RESP_EVENT
    ...
    // compliance: event=ACI_ATT_READ_MULTIPLE_RESP_EVENT
    ...
    // compliance: event=ACI_ATT_READ_BY_GROUP_TYPE_RESP_EVENT
    ...
    // compliance: event=ACI_ATT_PREPARE_WRITE_RESP_EVENT
    ...
    /// procedure itself.
    // compliance: event=ACI_GATT_ERROR_RESP_EVENT
    ...
    // compliance: event=ACI_GATT_DISC_READ_CHAR_BY_UUID_RESP_EVENT
    ...
    // compliance: event=ACI_GATT_WRITE_PERMIT_REQ_EVENT
    ...
    // compliance: event=ACI_GATT_READ_PERMIT_REQ_EVENT
    ...
    ///
    /// See the Bluetooth Core v4.1 spec, Vol 3, Part F, section 3.4.4.
    // compliance: event=ACI_GATT_READ_MULTI_PERMIT_REQ_EVENT
    ...
    // compliance: event=ACI_GATT_TX_POOL_AVAILABLE_EVENT
    ...
    // compliance: event=ACI_GATT_SERVER_CONFIRMATION_EVENT
    ...
    /// application.
    // compliance: event=ACI_GATT_PREPARE_WRITE_PERMIT_REQ_EVENT
    ...
    /// default value.
    // compliance: event=ACI_GATT_READ_EXT_EVENT
    ...
    /// default value.
    // compliance: event=ACI_GATT_INDICATION_EXT_EVENT
    ...
    /// `ATT_MTU > (BLE_EVT_MAX_PARAM_LEN - 4)` i.e. `ATT_MTU > 251` for `BLE_EVT_MAX_PARAM_LEN`
    /// default value.
    // compliance: event=ACI_GATT_NOTIFICATION_EXT_EVENT
    ...
    // compliance: event=ACI_HAL_END_OF_RADIO_ACTIVITY_EVENT
