...
stm32wb_hci_macros::vendor_event! {
    ...
    #[cfg(all(before_fw_1_24_0, feature = "stack-full-extended"))]
    ...
    #[cfg(all(
        before_fw_1_22_0,
        any(feature = "stack-full-extended", feature = "stack-full", feature = "stack-light")
    ))]
    ...
    #[cfg(all(before_fw_1_23_0, feature = "stack-full-extended"))]
    ...
    #[cfg(all(since_fw_1_23_0, feature = "stack-full-extended"))]
    GattEattBrearer(0x0C19) {
        Payload = {
            conn_handle: ConnHandle,
            channel_index: L2CocChannelIndex,
...
impl_attribute_value_accessor!(AttWritePermitRequest<'_>);
